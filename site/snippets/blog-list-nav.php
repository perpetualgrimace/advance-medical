<div class="g-col g-6 u-left-center">
  ...
  <div class="button-group">
    ...
    <a href="#blog-article" class="button" data-type-trigger><? snippet('icon-article-white.svg') ?> <?= $page->articlePost() ?></a>
    <a href="#blog-video" class="button" data-type-trigger><? snippet('icon-video-white.svg') ?> <?= $page->videoPost() ?></a>
    <a href="#blog-release" class="button" data-type-trigger><? snippet('icon-release-white.svg') ?> <?= $page->releasePost() ?></a>
  </div>
</div>

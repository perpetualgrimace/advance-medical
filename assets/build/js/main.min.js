...
$(document).ready(function() {
  ...
  // add a focus class to the parent
  parentFocus('.career-card-title', '.career-card-inner');
...
$(document).ready(function() {
  ...
  interactiveMap('contact-link', 'contact-location-dot');
...
$(document).ready(function() {
  ...
  interactiveMap('heatmap-link', 'heatmap-zone');

...
var proxyUrl        = 'localhost:8888/advance-medical.com/';
var scssMainPath    = 'assets/scss/*.scss';
var scssPartialPath = 'assets/scss/**/*.scss';
var scssPatternPath = 'site/patterns/**/*.scss';
...
gulp.task('default', ['dev-styles', 'production-styles', 'scripts', 'browser-sync'], function() {
  ...
  gulp.watch([scssMainPath, scssPartialPath, scssPatternPath], ['dev-styles', 'production-styles']);

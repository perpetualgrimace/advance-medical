...
<link rel="apple-touch-icon"      sizes="180x180" href="<?= $iconsPath ?>/apple-touch-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192" href="<?= $iconsPath ?>/favicon-192x192.png">
<link rel="icon" type="image/png" sizes="160x160" href="<?= $iconsPath ?>/favicon-160x160.png">
...
<meta name="msapplication-TileColor" content="#007FD0">

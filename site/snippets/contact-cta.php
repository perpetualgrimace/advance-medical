...
<div class="section contact-cta cta">
  <div class="g-col g-12 u-margins-auto u-padding-bottom u-padding-top-off u-center">
    ...
    <a href="mailto:<?= $emailAddress ?>" class="contact-cta-link g-8 gamma u-margins-auto u-underline-off"><? snippet('icon-mail.svg') ?> <span class="u-underline"><?= $emailAddress ?></span></a>
  </div>
</div>
